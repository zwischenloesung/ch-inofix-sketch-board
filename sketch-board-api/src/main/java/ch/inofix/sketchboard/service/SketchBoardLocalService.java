...
/**
 * Provides the local service interface for SketchBoard. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SketchBoardLocalServiceUtil
...
public interface SketchBoardLocalService extends BaseLocalService,
	...
	*/
	...
	public SketchBoard addSketchBoard(SketchBoard sketchBoard);
	...
	*/
	public SketchBoard createSketchBoard(long sketchBoardId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SketchBoard deleteSketchBoard(SketchBoard sketchBoard);
	...
	*/
	...
	public SketchBoard fetchSketchBoard(long sketchBoardId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SketchBoard fetchSketchBoardByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SketchBoard getSketchBoardByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SketchBoard> getSketchBoardsByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SketchBoard updateSketchBoard(SketchBoard sketchBoard);
}